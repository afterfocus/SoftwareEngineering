...
public class Dialogs {
    ...
    public static Dialog<Car> getAddCarDialog() {
            ...
            TextField fuelIDField = new TextField();
            ...
            fuelIDField.setPromptText("Тип топлива");
            ...
            carDialog.setResultConverter(dialogButton -> {
                if (dialogButton == confirmButton) {
                    try {
                        ...
                        return new Car(-1, modelField.getText(), maxSpeed, null, fuelConsumption);
