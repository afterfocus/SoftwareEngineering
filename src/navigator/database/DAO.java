...
public class DAO {
    ...
    public static String[] getStreetNames() {
        return new String[]{ "Московское шоссе", "Ташкентская", "Стара-Загора", "Ново-Садовая", "Лукачева",
                "Революционная", "Маломосковская", "Авроры", "Гагарина", "Луначарского", "Гаражная", "Гая",
                "Подшипниковая", "Ерошевского", "Мичурина", "пр.Масленникова", "Академика Солдатова"};
    }
    ...
    public static RoadSurface[] getRoadSurfaces() {
        return new RoadSurface[] {
                ...
                new RoadSurface("Новый асфальт", 0.8),
                new RoadSurface("Асфальт", 0.6),
